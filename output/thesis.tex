...
presence of existing tensions and challenges and a changing resource
...
co-ordinate distributed consumer-owned energy resources (see
...
settings, but from solutions that combine and compromise, e.g.~between
centralised (i.e.~SO-mediated) an decentralised (i.e.~market-mediated)
decision-making. Chapters \ref{sec:fcs},
Sections~\ref{sec:reserves}, \ref{sec:info} attempt to take such an
approach when assessing how best to balance power systems and
electricity markets with increasing penetrations of variable renewable
energy in operational timeframes.
...
The broad aim of this thesis is outlined below:

\textbf{\textbf{Given existing design challenges and growing
penetrations of variable renewable energy resources as energy transition
proceeds, how should we design or, at the very least, approach the
design of operational practices for balancing power systems and
electricity markets?}}
