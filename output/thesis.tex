...
\hypertarget{sec:fcs}{%
\chapter{Designing frequency control arrangements: insights from the
National Electricity Market}\label{sec:fcs}}
...
problem, these outcomes require flexible, ``second-best'' and
...
provision qenergy storage resources, which are widely touted to be
...
that revenue reductions can be significant, ranging from from
\textasciitilde15--20\% reduction in potential annual arbitrage revenue
...
\hypertarget{network-constraints}{%
\subsection{Network constraints}\label{network-constraints}}

\hypertarget{demand-response-and-distributed-consumer-owned-energy-resources}{%
\subsection{Demand response and distributed, consumer-owned energy
resources}\label{demand-response-and-distributed-consumer-owned-energy-resources}}

\hypertarget{examining-market-structure}{%
\subsection{Examining market
structure}\label{examining-market-structure}}
