...
Section~\ref{sec:lit_review-need_for_balancing}). A \emph{control area},
on the other hand, is a network area in which a particular \emph{system
...
Maintaining a stable, secure and reliable power system is vital;
...
\subsection{Active power balancing}\label{active-power-balancing}}
...
requires coordination \emph{across the power system} because of
transmission losses and network constraints imposed by line thermal
limits, stability requirements \& Kirchoff's circuit laws
...
\hypertarget{sec:lit_review-need_for_balancing}{%
\subsubsection{Why is balancing
required?}\label{sec:lit_review-need_for_balancing}}
...
such, SOs often employ emergency frequency control schemes that trip
loads in the event of under-frequency (\emph{under-frequency load
shedding} or \emph{UFLS}) or generation in the event of over-frequency
(\emph{over-frequency generation shedding} or \emph{OFGS}) as a last
line of defence against frequency-driven system collapse
...
\hypertarget{threats-to-active-power-balance}{%
\subsubsection{Threats to active power
balance}\label{threats-to-active-power-balance}}
