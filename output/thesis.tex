...
storage: an Australian National Electricity Market case
study}\label{sec:info}}
...
forecast data from 5MPD) ahead of delivery. The dashed and annotated
...
\caption{File sizes of monthly NEM bid and offer data zipfiles from 2012
...
every year from 2013 to 2021. The number at the top of each column is
the total number of rebids made in June of that year. June was selected
...
and binned by offer price, and the NEM-wide volume weighted average
prices on June 4 2021 and June 4 2023. Note that BESS, like other
resources in the NEM, tend to shift capacity to lower price bands during
periods of high prices. While BESS capacity was predominantly offered in
at 1000+ AUD/MW/hr between high price events in 2021, there was a higher
degree of quantity segmentation across 50 AUD/MW/hr+ price bands in 2023
...
\caption{VPI (bars with black edges) and VPF (bars with grey edges) for
