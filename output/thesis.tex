...
pictures of the Calypso (\protect\hyperlink{ref-Cousteau1963}{Cousteau
Jacques and Dugan James, 1963}).
...
Proin faucibus nibh sit amet augue blandit varius\footnote{Try a
  footnote}.
...
\chapter{First research study, with code}\label{sec:first}}
...
\hypertarget{sec:subsec-code-example}{%
\subsection{Subsection 1 with example code
block}\label{sec:subsec-code-example}}
...
By running the code in Chapter~\ref{sec:subsec-code-example}, we solved
AI completely. This is the second part of the methodology. Proin
...
Cousteau Jacques, Dugan James, 1963. {The Living Sea: by Jacques-Yves
Cousteau}. Hamish Hamilton, London.
