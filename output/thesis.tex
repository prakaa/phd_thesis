...
designers and energy system policy-makers based on detailed empirical
...
upon the functions of existing operational practices. Chapter
\ref{sec:reserves} focuses on understanding the balancing flexibility
\textbf{capabilities} available in scheduling timeframes both now and
...
need for an additional reserve product market. I finally recommend that
