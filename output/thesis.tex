...
al., 2023}), though a key assumption of these studies is that
...
National Electricity Market (NEM), which refers to both the power system
and electricity market that service \textasciitilde80\% of the country's
...
\hypertarget{thesis-research-question-and-objectives}{%
\section{Thesis research question and
objectives}\label{thesis-research-question-and-objectives}}
...
following research \textbf{objectives}:
...
research \textbf{methods}:

\begin{enumerate}
\def\labelenumi{\arabic{enumi}.}
\tightlist
\item
  Reviews of academic and industry literature on the design of
